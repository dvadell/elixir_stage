...
#
#     PHX_SERVER=true bin/soundai start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :soundai, SoundaiWeb.Endpoint, server: true
end
  ...
  config :soundai, SoundaiWeb.Endpoint,
    live_reload: [
      ...
      patterns: [
        ...
        ~r"lib/soundai_web/router\.ex$"E,
        ~r"lib/soundai_web/(controllers|live|components)/.*\.(ex|heex)$"E
      ]
    ]
end
...
# by passing the PHX_SERVER=true when you start it:
#
#     PHX_SERVER=true bin/soundpanel start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :soundpanel, SoundpanelWeb.Endpoint, server: true
end
  ...
  config :soundpanel, SoundpanelWeb.Endpoint,
    live_reload: [
      ...
      patterns: [
        ...
        ~r"priv/gettext/.*\.po$"E,
        # Router, Controllers, LiveViews and LiveComponents
        ~r"lib/soundpanel_web/router\.ex$"E,
        ~r"lib/soundpanel_web/(controllers|live|components)/.*\.(ex|heex)$"E
      ]
    ]
end
